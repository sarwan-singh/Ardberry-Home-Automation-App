...
public class InsideButtonHorizontal extends AppCompatActivity {

    private boolean status = true;

    private int initial_state,final_state, difference_state,delay_number;

    String url  = "http://192.168.1.1/specificArgs"+"?"+"slider2=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inside_button_horizontal);
        SeekBar seekBar = findViewById(R.id.seek_bar);

        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS2,MODE_PRIVATE);
        int a = sharedPreferences.getInt(tempNumber2,0);
        progressMain = a;
...
//        SlideAnimationUtil.fadeMain2(this, seekBar);
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(final SeekBar seekBar) {
                ...
                editor.putInt(tempNumber2,final_state);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(InsideButtonHorizontal.this,InsideHouse.class);
