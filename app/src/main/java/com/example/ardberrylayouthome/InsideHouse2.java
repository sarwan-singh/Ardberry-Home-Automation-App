...
public class InsideHouse2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inside_house2);
...
//        SlideAnimationUtil.fadeMain2(this, seekBar);
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress,
                ...
                if (progress == 21){
                    seekActivity(21,seekBar);
                }
                if (progress == 22){
                    seekActivity(22,seekBar);
                }
            ...
            public void onStopTrackingTouch(final SeekBar seekBar) {
                ...
                Toast.makeText(getApplicationContext(),"Angle = " + seekBar.getProgress()*16.3636 + "" , (int) (Toast.LENGTH_SHORT*0.5)).show();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(InsideHouse2.this,Houses.class);
